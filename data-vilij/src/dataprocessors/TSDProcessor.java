...
public final class TSDProcessor {
    ...
    public static class DuplicateDataNameException extends Exception {
        ...
        private static final String DUPLICATE_ERROR_MSG = "There is an existing instance name.";
        
        public DuplicateDataNameException(String name) {
            super(String.format("Duplicate name '%s'." + DUPLICATE_ERROR_MSG, name));
        }
    }
    ...
    public void processString(String tsdString) throws Exception {
        ...
        AtomicInteger errLine = new AtomicInteger(1);
        ...
        Stream.of(tsdString.split("\n"))
              ...
              .forEach(list -> {
                  try {
                      ...
                      errLine.getAndIncrement();
                  } catch (Exception e) {
                      errorMessage.setLength(0);
                      errorMessage.append("Format or Duplicate error in Line "+errLine).append(": ").append(e.getMessage());
                      hadAnError.set(true);
                  }
              });
    ...
    private String checkedname(String name) throws InvalidDataNameException, DuplicateDataNameException {
        ...
        if (dataLabels.containsKey(name) && dataPoints.containsKey(name))
